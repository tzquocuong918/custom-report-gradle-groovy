...
class CypherReportProvider extends AbstractReportProvider {
	...
	void process(ReportResult reportResult) {
		...
		Map<String,Object> headerData = [total_items: totalItems, password_items: passwordResults,secret_items : tfvarsResults, tfvars_items: secretResults, uuid_items: uuidResults, key_items: keyResults, random_items: randomResults]
